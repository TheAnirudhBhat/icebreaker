...
const PROPS: { crop: CSSProperties; title: string }[] = [
  ...
  { crop: { height: "703.14%", left: "-40.36%", top: "-511.52%", width: "1064.66%" }, title: "Answer a few fun questions" },
];
...
export default function TriggerCard({
  ...
  return (
    <div style={{ background: BG_SHEET, display: "flex", flexDirection: "column", height: "100%" }}>
      <div style={{ flex: 1, overflowY: onDevice ? "hidden" : "auto", overscrollBehavior: "none", display: "flex", flexDirection: "column", justifyContent: onDevice ? "center" : "flex-start", padding: onDevice ? "16px 24px 24px" : "0px 24px 8px" }}>
